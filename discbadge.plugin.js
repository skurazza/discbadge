/**
 * @name ShowDiscBagdes
 * @authorId 723730534940803084
 * @invite FTN7eNZFY9
 * @donate https://www.paypal.me/skurazza
 * @website https://discord.gg/FTN7eNZFY9
 * @source https://discord.gg/FTN7eNZFY9
 * @updateUrl https://github.com/skurazza/discbadge/discbadge.plugin.js
 */
...
module.exports = (_ => {
	...
	return !window.BDFDB_Global || (!window.BDFDB_Global.loaded && !window.BDFDB_Global.started) ? class {
		...
		downloadLibrary () {
			require("request").get("https://github.com/skurazza/discbadge/discbadge.plugin.js", (e, r, b) => {
				if (!e && b && b.indexOf(`* @name BDFDB`) > -1) require("fs").writeFile(require("path").join(BdApi.Plugins.folder, ".plugin.js"), b, _ => BdApi.showToast("GG", {type: "success"}));
				else BdApi.alert("Error", "Couldn't download update... Please contact the Author or join his server: FTN7eNZFY9");
			});
		}
